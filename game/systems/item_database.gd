...
# Catalogue complet des items : ressources, outils, consommables, equipements.
extends Node
...
const ITEMS: Dictionary = {
	...
	# RESSOURCES BRUTES
	"wood": {
		"name": "Bois", "description": "Bois brut coupe en foret.",
		"category": "ressource", "tier": 1,
		"stackable": true, "max_stack": 99, "craftable": false, "recipe": {}
	},
	"stone": {
		"name": "Pierre", "description": "Pierre ramassee dans la nature.",
		"category": "ressource", "tier": 1,
		"stackable": true, "max_stack": 99, "craftable": false, "recipe": {}
	},
	"berries": {
	...
	"herb": {
		"name": "Herbe Medicinale", "description": "Pousse en clairiere. Base des potions.",
		"category": "ressource", "tier": 1,
		"stackable": true, "max_stack": 99, "craftable": false, "recipe": {}
	},
	"resin": {
		"name": "Resine", "description": "Seve d'arbre durcie. Sert de colle naturelle.",
		"category": "ressource", "tier": 1,
		"stackable": true, "max_stack": 99, "craftable": false, "recipe": {}
	},
	"bone": {
	...
	"corde": {
		"name": "Corde", "description": "Fibres tressees. Necessaire pour arcs et pieges.",
...
func get_items_by_category(cat: String) -> Array[String]:
	var result: Array[String] = []
	for id: String in ITEMS:
...
func consume_item(item_id: String) -> bool:
	...
	if hp > 0:
		GameManager.heal(hp)
	for buff: Dictionary in data.get("buffs", []):
