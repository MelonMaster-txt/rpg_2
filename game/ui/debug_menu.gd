...
func _build_ui() -> void:
	...
	var btn_slow: Button = Button.new()
	btn_slow.text = "-"
	...
	var btn_spawn1: Button = Button.new()
	...
	var btn_spawn5: Button = Button.new()
	...
	var btn_clear_npc: Button = Button.new()
...
func _refresh_stats() -> void:
	for key: String in _stat_labels:
		var val: Variant = GameManager.get(key)
